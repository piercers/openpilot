...
class Controls:
  ...
  def state_control(self):
    ...
    lateral_only = self.sm['selfdriveState'].state == State.lateralEnabled
    CC.longActive = CC.enabled and not lateral_only and not any(e.overrideLongitudinal for e in self.sm['onroadEvents']) and self.CP.openpilotLongitudinalControl
